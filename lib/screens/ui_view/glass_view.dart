                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 80, bottom: 12, right: 16, top: 12),
                                child: Text(
                                  'กดดาววิชาที่คุณสนใจในรายการสืบค้นมร.30 เพื่อดูวิดีโอคำบรรยายย้อนหลังตามปี/ภาคการศึกษา และแจ้งเตือนเข้าห้องเรียนในหน้าตารางเรียนวันนี้',
